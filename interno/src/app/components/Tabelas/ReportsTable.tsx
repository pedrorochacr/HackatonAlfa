              ...
              <tr className="btn-ghost" key={report.id}>
                ...
                <td>
                  <div className="flex items-center space-x-3">
                    <div>
                      <div className="font-bold text-white">
                        {report.localizacao.replace(regex, '')}
                      </div>
                      {report.localizacao && (
                        <div
                          onClick={() => {
                            const [latitude, longitude] =
                              report.localizacao.split(' ');
                            window.open(
                              `https://www.google.com/maps/@${latitude},${longitude},`,
                              '_blank'
                            );
                          }}
                          className="pl-6 hover:font-bold cursor-pointer"
                        >
                          Pesquisar no Maps
                        </div>
                      )}
                ...
                <td>
                  <div className="flex items-center space-x-3">
                    <div>
                      <div className="font-bold text-white">
                        {report.centroDeCustos.replace(regex, '')}
                      </div>
                    </div>
                  </div>
                </td>
                <td>
                  <div className="flex items-center space-x-3">
                    <div>
                      <div className="font-bold text-white">
                        {report.refAreaAtuacao.replace(regex, '')}
                      </div>
                    </div>
                  </div>
                </td>
